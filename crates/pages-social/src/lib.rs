...
pub mod scenes {
    pub use crate::_generated_snapshot_scenes::{
        SnapAddressBookPage, SnapChatPage, SnapCommentsPage, SnapCommunityForumPage,
        SnapContactDetailPage, SnapDialerPage, SnapEmailThreadPage, SnapGroupChatListPage,
        SnapInboxPage, SnapMessageComposerPage, SnapNewsArticleFeedPage, SnapPostCreatorPage,
        SnapPostDetailPage, SnapProfileEditPage, SnapProfilePage, SnapTrendingTopicsPage,
        SnapVideoCallPage,
    };
}
