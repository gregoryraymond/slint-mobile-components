---
name: slint-ui
description: Guide for building Slint UI components and applications in Rust, covering .slint syntax, layouts, properties, callbacks, data models, animations, and Rust ↔ Slint integration. Apply when working with .slint files, slint-build, or designing reusable Slint components (including mobile/Android consumers).
user-invocable: true
